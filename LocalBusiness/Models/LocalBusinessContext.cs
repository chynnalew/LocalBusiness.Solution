  ...
  public class LocalBusinessContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Business>().HasData(
        ...
        new Business { BusinessId = 5, Name = "Sunee's Thai", Type = "Restaurant", Genre = "Thai", Address="1400 SE Stark St, Portland, OR 97214", Description = "Casual restaurant serving out noodles, curries & other classic Thai dishes", Price = 2 },
        ...
        new Business { BusinessId = 15, Name = "Anatomy Tattoo", Type = "Shop", Genre = "Tattoo", Address="2820 NE Sandy Blvd, Portland, OR 97232", Description = "A bright and open tattoo shop offering a variety of styles", Price = 3 },
